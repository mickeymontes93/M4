...
char *lexpal[MAXPAL] = {    "arccos", "arcsin", "arctan", "arr.bool", "arr.char", "arr.float", "arr.int", "arr.str", "break", "cadena", "case", "comentario","concat", "console.read",
                            ...
                            "trim", "true", "var.bool", "var.char", "var.file", "var.float", "file.fopen", "file.fscanf", "var.int", "var.str", "while"
                       };
...
enum simbolo tokpal [MAXPAL] = {tok_arccos, tok_arcsin, tok_arctan, tok_arrBooleano, tok_arrCaracter, tok_arrFlotante, tok_arrEntero, tok_arrCadena,
                                tok_break, tok_cadena, tok_case,COMENTARIO, tok_concat, tok_read, tok_write, tok_cos, tok_default, tok_do, tok_else, tok_equal,
                                tok_false, tok_fclose, tok_fgets, tok_for, tok_bool, tok_funcchar, tok_funcfloat, tok_funcint, tok_funcstr, tok_funcvoid,
                                tok_if, tok_length, tok_log, tok_main, tok_pow, tok_replace, tok_return, tok_round, tok_sin, tok_split, tok_sqrt, tok_substring,
