...
void FUNCION_INSTRUCCION(int toksig[]), CONJUNVAR(int toksig[], int declaracion), DECLARACION(int toksig[], int *idat), OPERACION_NUM(int toksig[]), TERMINO(int toksig[]), ASIGNACION(int toksig[]), FUN_SUBSTRING(int toksig[]), FUN_CONCAT(int toksig[]),
